...
_BLOTTER_COLUMNS = [
    {"name": "ID", "id": "id", "editable": False, "resizable": True},
    {"name": "Time", "id": "added_time", "editable": False, "resizable": True},
    {"name": "Underlying", "id": "underlying", "editable": False, "resizable": True},
    {"name": "Structure", "id": "structure", "editable": False, "resizable": True},
    {"name": "Bid", "id": "bid", "editable": False, "resizable": True},
    {"name": "Mid", "id": "mid", "editable": False, "resizable": True},
    {"name": "Offer", "id": "offer", "editable": False, "resizable": True},
    {"name": "Bid Size", "id": "bid_size", "editable": False, "resizable": True},
    {"name": "Offer Size", "id": "offer_size", "editable": False, "resizable": True},
    {"name": "Bid/Offered", "id": "side", "editable": True, "presentation": "dropdown", "resizable": True},
    {"name": "Size", "id": "size", "editable": True, "resizable": True},
    {"name": "Traded", "id": "traded", "editable": True, "presentation": "dropdown", "resizable": True},
    {"name": "Bought/Sold", "id": "bought_sold", "editable": True, "presentation": "dropdown", "resizable": True},
    {"name": "Traded Px", "id": "traded_price", "editable": True, "resizable": True},
    {"name": "Initiator", "id": "initiator", "editable": True, "resizable": True},
    {"name": "PnL", "id": "pnl", "editable": False, "resizable": True},
]
    ...
    return html.Div(
        ...
        children=[
            dash_table.DataTable(
                id="pricing-display",
                columns=[
                    {"name": "Leg", "id": "leg", "editable": False, "resizable": True},
                    {"name": "Expiry", "id": "expiry", "editable": True, "resizable": True},
                    {"name": "Strike", "id": "strike", "editable": True, "type": "numeric", "resizable": True},
                    {"name": "Type", "id": "type", "editable": True, "presentation": "dropdown", "resizable": True},
                    {"name": "Ratio", "id": "ratio", "editable": True, "type": "numeric", "resizable": True},
                    {"name": "Bid Size", "id": "bid_size", "editable": False, "resizable": True},
                    {"name": "Bid", "id": "bid", "editable": False, "resizable": True},
                    {"name": "Mid", "id": "mid", "editable": False, "resizable": True},
                    {"name": "Offer", "id": "offer", "editable": False, "resizable": True},
